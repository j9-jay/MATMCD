...
| [011](TASK_011_summary_output_directory.md) | CODE-03 필수 요약 저장 경로 준비 | DONE — 경로·쓰기 권한·원본 보존 확인 |

후속 조사와 blocker 처리는 010부터 번호를 이어서 관리한다. 007~009는 실행 순서를 뜻하는 후속 의존 작업이며 실제 수행하지 않았다.
